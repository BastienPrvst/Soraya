 ...
 */
final class Version20260126180015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT AUTO_INCREMENT NOT NULL, hash VARCHAR(255) NOT NULL, expiration_date DATETIME NOT NULL, type TINYINT NOT NULL, value INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
